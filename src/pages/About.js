    ...
    return(
        <div className="About">
            <div className="content-page">
                ...
                <p>Das Projekt versammelt im ersten Schritt zehn Ideen des freien Autors und Frankfurters Kenneth Hujer, der auch die Idee zum Projekt „Rom/Döner“ hatte. Seine Ideen eröffnen gleichsam das Spannungsfeld des Projekts, unterstreichen das erwünschte out-of-the-box-Denken und wirken bestenfalls inspirierend. Denn es sollen viele weitere Ideen folgen – von Menschen aus den unterschiedlichsten Tätigkeitsfelder und Kontexten. Gerne können auch in Eigeninitiative Ideen eingereicht werden. Auf dass das Projekt „Rom/Döner“ zu einem großen Ideen-Konglomerat anwächst!</p>
